...
import com.abhidev.models.Analysis.MCQ;
...
public interface AnalysisEventListener extends BaseViewAction {
    ...
    void showProfessionalCertficationScreen();
    ...
    void showHistoryAndGoalsSectionEndScreen();
    void showMeOrNotMeQue1();
    ...
    void finishActivity();
    void showEgoGramIntroScreen();
    void showQuestion8Screen();
    void showQuestion10Screen();
    void showQuestion11Screen();
    ...
    void showEgoGramQue1Screen();
    void showEgoGramQue2Screen();
    void showEgoGramQue3Screen();
    void showEgoGramQue4Screen();
    void showEgoGramQue5Screen();
    void showEgoGramQue6Screen();
    void showEgoGramQue7Screen();
    void showEgoGramQue8Screen();
    void showEgoGramQue9Screen();
    void showEgoGramQue10Screen();
    void showEgoGramQue11Screen();
    void showEgoGramQue12Screen();
    void showEgoGramQue13Screen();
    void showEgoGramQue14Screen();
