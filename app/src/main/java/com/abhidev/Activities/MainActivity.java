...
import com.abhidev.Exams.Activities.ExamsActivity;
import com.abhidev.Fragments.HomeFragment;
import com.abhidev.HelpDesk.HelpDeskActivity;
import com.abhidev.R;
import com.abhidev.bottomfragments.ProfileFragment;

import com.abhidev.adapters.BottomNavigationAdapter;
import com.abhidev.apiservices.responses.AuthenticationResponse;
import com.abhidev.common.CustomTypefaceSpan;
import com.abhidev.common.MyApplication;
import com.abhidev.listeners.OnUserReceivedListener;
import com.abhidev.listeners.auth.OnAuthenticatedListener;
import com.abhidev.models.User;
import com.abhidev.presenters.AuthenticationPresenter;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.scholar){
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    openBrowser("https://play.google.com/store/apps/details?id=com.wireouttechnologies.wordfox");
        ...
        else if (id==R.id.nav_share)
        {
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey, Looking for career options and courses as per your skills & Interests but confused. Then sign-up at Tomorrow4U to give Free Career Assessment and create your own Career Journey with best suited Career Options and Courses.https://play.google.com/store/apps/details?id=com.wireout");
...
//        }
        else if (id==R.id.publication)
        {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent=new Intent(MainActivity.this, com.abhidev.GameBrainBooster.MainActivity.class);
