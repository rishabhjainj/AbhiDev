...
public class LoginActivity extends BaseActivity implements OnAuthenticatedListener, GoogleApiClient.OnConnectionFailedListener{
    ...
    LoginButton facebookLoginButton; CallbackManager callbackManager;
    SignInButton googleSignInButton; private GoogleApiClient googleApiClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                presenter.loginDefault(email.getText().toString(), password.getText().toString());
