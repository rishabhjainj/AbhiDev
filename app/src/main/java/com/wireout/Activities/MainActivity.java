...
import com.wireout.HelpDesk.HelpDeskActivity;
import com.wireout.R;
import com.wireout.bottomfragments.ProfileFragment;

import com.wireout.adapters.BottomNavigationAdapter;
import com.wireout.apiservices.responses.AuthenticationResponse;
import com.wireout.common.CustomTypefaceSpan;
...
//        }
        else if (id==R.id.publication)
        {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent intent=new Intent(MainActivity.this, com.wireout.GameBrainBooster.MainActivity.class);
